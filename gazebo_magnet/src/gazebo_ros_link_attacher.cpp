...
#include <ros/ros.h>
#include "gazebo_magnet/gazebo_ros_link_attacher.h"
#include "gazebo_magnet/Attach.h"
...
namespace gazebo
{
                                     ...
                                     std::string model2, std::string link2)
  {
    ...
    j.joint->SetUpperLimit(0, 0.0);
    ROS_DEBUG_STREAM("SetLowStop");
    j.joint->SetLowerLimit(0, 0.0);
  ...
  bool GazeboRosLinkAttacher::attach_callback(gazebo_magnet::Attach::Request &req,
                                              gazebo_magnet::Attach::Response &res)
  {
  ...
  bool GazeboRosLinkAttacher::detach_callback(gazebo_magnet::Attach::Request &req,
                                              gazebo_magnet::Attach::Response &res){
