...
class TestLoop:
 ...
 #                                      ])
        ...
        pose_pub = rospy.Publisher('/mavros'+ uav_prefix + '/actuator_control', ActuatorControl, queue_size=10)
	    ...
	    des_act = ActuatorControl()
	    
	    des_act.group_mix = 0
	    des_act.controls[3] = 0.8

            pose_pub.publish(des_act)
            rate.sleep()
...
if __name__ == "__main__":
     TestLoop(float(1), float(1), str(1), float(0))
