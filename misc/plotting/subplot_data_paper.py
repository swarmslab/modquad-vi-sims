...
yh = ax11_yh
yl = ax11_yl
figname = '/home/guanrui/my_paper/Vi-ModQuad-ICRA-2019/figs/position-x.pdf'
#figname = '/home/guanrui/my_paper/Vi-ModQuad-ICRA-2019/figs/velocity-z.pdf'
#figname = '/home/guanrui/my_paper/Vi-ModQuad-ICRA-2019/figs/acc-imu-all.png'
...
fig1.set_ylim(yl, yh)
fig1.set_xlim(0,30)
fig1.set_ylabel(r'$x_{\mathit{d}}^{\mathcal{M}_{\mathit{w}}}\hspace{0.5} (m)$',fontsize = label_font)
#fig1.set_ylabel(r'$\dot{z}_{\mathit{d}}^{\mathcal{M}_{\mathit{w}}}\hspace{0.5} (m/s)$',fontsize = label_font)
#fig1.set_ylabel(r'$\mathbf{a}_{m_x}\hspace{0.5} (m/s^2)$',fontsize = label_font)
...
for topic, position, stamp in bag.read_messages(topics=['/whycon/poses']):
	...
	fig1.plot(np.asarray([whycon_docktime,whycon_docktime]),np.asarray([-10,10]),'r--')
	fig1.plot(np.asarray([track_time_s,track_time_s]),np.asarray([-10,10]),'g--')
	fig1.plot(np.asarray([dock_time_s,dock_time_s]),np.asarray([-10,10]),'g--')
...
fig1.legend(fontsize = legend_font)
